...
## Phase 1-1 화면별 wireframe spec

| 화면 | Spec |
| --- | --- |
| Login Screen | `prototypes/astra-shell/screens/login-screen.md` |
| Desktop | `prototypes/astra-shell/screens/desktop.md` |
| Dock | `prototypes/astra-shell/screens/dock.md` |
| Launcher | `prototypes/astra-shell/screens/launcher.md` |
| Control Center | `prototypes/astra-shell/screens/control-center.md` |
| Notification Center | `prototypes/astra-shell/screens/notification-center.md` |
| Workspace View | `prototypes/astra-shell/screens/workspace-view.md` |
| Settings Mock | `prototypes/astra-shell/screens/settings-mock.md` |
| Security Center Mock | `prototypes/astra-shell/screens/security-center-mock.md` |
