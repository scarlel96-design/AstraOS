  ...
  const mockData = {
    ...
    strings: {
      ko: {
        ...
        "security.boundaryTitle": "Phase 1-5 보안 경계",
        ...
        "login.description": "Phase 1-5에서는 실제 인증 없이 화면 전환만 확인합니다. 입력란과 버튼은 mock UI입니다.",
        ...
        "section.desktopSurface": "데스크톱 surface",
        "section.shellPanels": "Shell 패널",
        "section.overlayPreview": "Overlay mock",
        "section.appWindow": "App window mock",
        "metric.routes": "route",
      ...
      en: {
        ...
        "security.boundaryTitle": "Phase 1-5 Security Boundary",
        ...
        "login.description": "Phase 1-5 only verifies screen transitions without real authentication. Fields and buttons are mock UI.",
        ...
        "section.desktopSurface": "Desktop surface",
        "section.shellPanels": "Shell panels",
        "section.overlayPreview": "Overlay mock",
        "section.appWindow": "App window mock",
